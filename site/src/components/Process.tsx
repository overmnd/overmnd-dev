import { CheckCircle, Server, MousePointer } from 'lucide-react';

/**
 * Simple three-step process with stable lucide-react icons.
 * We intentionally use icons that exist in all recent lucide versions.
 */
export default function Process() {
  const steps = [
    ...
    { icon: CheckCircle, title: 'Fix', text: 'Enable Overmnd-Fix, run one-click actions, and undo as needed.' }
  ];
  return (
